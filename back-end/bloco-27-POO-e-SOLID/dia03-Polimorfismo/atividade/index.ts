...
// carolina.addEvaluationResult(new EvaluationResult(examMath, 23, 'prova'));
// carolina.addEvaluationResult(new EvaluationResult(workMath, 42, 'trabalho'));
// carolina.addEvaluationResult(new EvaluationResult(examHistory, 25, 'prova'));
// carolina.addEvaluationResult(new EvaluationResult(workHistory, 50, 'trabalho'));

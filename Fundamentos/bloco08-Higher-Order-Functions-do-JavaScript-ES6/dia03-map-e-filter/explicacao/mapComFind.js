const estudantes = [
  ...
  // Função para buscar um estudante e retornar a situação dele em cada matéria
  // Com For
  ...
  const reportStatuss = (name, students) => {
  ...
  console.log(reportStatuss('Natalia', estudantes));
